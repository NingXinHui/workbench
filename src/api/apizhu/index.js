...
// 员工管理的职位获取
export function positionDataList(query) {
  // 根据编码获取值 /sm/dict-data/list/{typeCode}
  return request({
    // url: "/sm/dict-data/list/" + query.position,
    url: "/sm/dict-data/list-usable/" + query,
    method: "get"
  });
}
...
export function companyListSelect(data) {
  return request({
    ...
    method: "get",
    // params: data
    params: { ...data, current: data.pageNo, size: data.pageSize }
  });
}
//查询用户的数据权限配置
export function searchPermission(data) {
  return request({
    url: "/uc/user/list/data-permission/" + data.id,
    method: "get"
  });
}
//保存用户的数据权限配置
export function operatePermission(data) {
  return request({
    url: "/uc/user/operate-permission",
    method: "post",
    data: data
  });
}
...
// 公司下拉对应的部门
export function departmentListSelect(query) {
  console.log(query);
  return request({
    url: "/uc/department/list/select/",
    // url: "/uc/department/list/select/" + query.companyId,
...
export function theDepartmentListSelect(query) {
  return request({
    url: `/uc/department/list/select/${query}`,
    // url: '/uc/department/list/select/' + query.companyId,
...
export function importDataList(query) {
  return request({
    url: "/uc/user/import",
    method: "post",
    data: query
