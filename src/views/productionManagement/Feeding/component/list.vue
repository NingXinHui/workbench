  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        //       props: {
        //         value: scope.row.billStatusName,
        //         disabled: true
        //       }
        //     });
        //   }
  ...
  methods: {
    ...
    initParams() {
      let params = {
        ...
        billNo: this.queryForm.orderNo,
        checkItemName: this.queryForm.checkItemName,
        deliveryTypeName: this.queryForm.deliveryTypeName,
        warehouseName: this.queryForm.warehouseName
      };
    ...
    exportCommonData(){
      ...
      let params = this.initParams();
      downloadsome(
        '/pd/feed-apply/export-current-page-data', params, '投料申请单模块清单.xls'
      )
    },
