...
<template>
  <div class="popBox">
    <el-dialog :title="approvalText"
      ...
      <div slot="footer"
           v-if="approvalText!='反审核'">
        <el-button @click="close">驳回</el-button>
        <el-button type="primary"
                   @click="submit">通过</el-button>
      </div>
      <div slot="footer"
           v-else>
...
import { completeNotice, cancelCompleteNotice, cancelCloseNotice, closeNotice } from '@/api/purchase/notice'
export default {
  name: "add",
  components: { formList },
