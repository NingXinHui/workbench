...
import { completePurchaseOrder,cancelCompletePurchaseOrder,closePurchaseOrder,cancelClosePurchaseOrder} from '@/api/purchase/order'
export default {
  name: "add",
  components: { formList },
